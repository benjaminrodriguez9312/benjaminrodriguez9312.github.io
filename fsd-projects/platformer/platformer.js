$(function () {
  ...
  function setup() {
    ...
    createPlatform(0,450,100,50); //leftmost platform
    createPlatform(350,660,100,50); //left right bottom platform
    createPlatform(300,460,100,50); //left right top platform
    createPlatform(600,550,100,50); //middle left platform
